...
### Migrate Inventory Model

Creates `inventory_levels`, `inventory_reservations`, and `inventory_movements`.
Backfills stock from `item_units` (if present) or `items.inventory`.
